...
// Blit to screen
bool j1Render::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, float scale, float speed, bool color, Color_Code code,  double angle, int pivot_x, int pivot_y, Uint8 alpha) const
{
	bool ret = true;
