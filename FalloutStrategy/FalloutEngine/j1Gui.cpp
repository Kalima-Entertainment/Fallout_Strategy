...
UI_element* j1Gui::CreateLabel(int x, int y, UI_Type type, const std::string text_input, UI_element* parent, j1Module* Observer, int* counter, std::string font)
{
